...
import { Search, Video, Users, MapPin, Coffee, ChevronLeft, ChevronRight, AlertCircle } from 'lucide-react'
      ...
      <div className="max-w-2xl mx-auto mb-12">
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex">
            ...
            <Link
              to="/search"
              className="bg-pink-600 text-white p-2 rounded-r-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500"
            >
              <Search size={24} />
            </Link>
          </div>
